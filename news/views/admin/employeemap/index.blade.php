...
<section class="content-header">
    <h1>@lang('employeemap/title.label')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <div class="card ">
            ...
            <div class="card-body table-responsive-lg table-responsive-sm table-responsive-md">
                <div class="form-group">
                    <div class="row">                        
                        <label for="fromdate" class="col-sm-1 control-label" style="margin-top: 5px;">@lang('employeemap/title.fromdate')</label>
                        <div class="col-sm-2">                            
                            <input type="text" id="fromdate" class="form-control" value="{{date('m/d/Y',strtotime('-1 week'))}}" />
                        </div>
                        <label for="todate" class="col-sm-1 control-label" style="margin-top: 5px;">@lang('employeemap/title.todate')</label>
                        <div class="col-sm-2">                            
                            <input type="text" id="todate" class="form-control" value="{{date('m/d/Y')}}"/>
                        </div>
                        <label for="employee" class="col-sm-1 control-label" style="margin-top: 5px;">@lang('employeemap/title.employee')</label>
                        <div class="col-sm-2">
                            {!!Form::select('us_id', $listemployees, null, ['class' => 'form-control', 'id' => 'us_id'])!!}
                        </div>
                        <div class="col-sm-1">
                            <button id="btn_calculate" class="btn btn-success">@lang('employeemap/title.calculate')</button>
                        </div>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    function loadmarker(){
        var urlajax = "{{route('admin.employeemap.getdata')}}";
        $.ajax({
            url: urlajax,
            type: 'POST',
            data: {

    ...
    <div class="row">
        ...
        <div class="card ">
            ...
            <div class="card-body table-responsive-lg table-responsive-sm table-responsive-md">
                ...
                <br/>
                <a href="{{route('admin.employees')}}" class="btn btn-primary">@lang('employees/title.back')</a>
            </div>
        </div>
    </div>
    </div><!-- row-->
...
<script>
    ...
    $(function() {        
        var table = $('#table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{!! route('admin.employees.getdatavacation',$us_id) !!}",
            order: [],
            columns: [
        ...
        $('#btn_save').click(function(){
            ...
            if(a != ''){            
                $.ajax({
                    url: "{{route('admin.employees.savevacation')}}",
                    type: 'POST',
                    data: {
                        us_id : "{{$us_id}}",
                        day : a,                    

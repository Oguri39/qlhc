        ...
        <div class="card ">
            <div class="card-header bg-primary text-white">
                ...
                <div align="center" style="width: 100%; position: absolute;">
                    ...
                    <a href="{{route('admin.employees.export')}}" class="btn btn-sm btn-success float-right" id="btn_export" style="margin-top: 10px;margin-right: 40px;">@lang('employees/title.export')</a>
                </div>                     
            </div>
                ...
                <div class="table-responsive-lg table-responsive-sm table-responsive-md">
                    ...
                    <table class="table table-bordered width100" border="1">
                        ...
                        <tr>
                            ...
                            <th><label>@lang('employees/title.role')</label></th>
                            <th width="18%">
                                <select id="role1" name="role1" class="form-control">
                                    <option value="0">@lang('employees/title.worker')</option>
                                    <option value="1">@lang('employees/title.mechanic')</option>
                                </select>
                            </th>
                        </tr>  
                        <tr>
...
<script>
    ...
    $(function() {        
        var table = $('#table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.employees.getdata',1) !!}',
            //order: [[ 6, "desc" ],[0, "asc"]],
            columns: [
        ...
        function checkSubmitform(){
            ...
            if(a != ''){            
                $.ajax({
                    url: "{{route('admin.employees.checkloginunique')}}",
                    type: 'POST',
                    data: {
                        login : a,                    
                        _token : '{{csrf_token()}}',
        ...
        function submitform(){
            ...
            var urlajax = "{{route('admin.employees.store')}}";
            if(us_id > 0){
                urlajax = "{{route('admin.employees.update')}}";
            } 

...
class UsersController extends JoshController
{
    ...
    public function create()
    {
        ...
        $scs = DB::table('schultes')->orderBy('sc_name')->get();
        $sc = array();
        foreach ($scs as $key => $value) {
            $sc[$value->sc_id] = $value->sc_name;
        }
        // Show the page
        return view('admin.users.create', compact('roles', 'countries', 'sc'));
    }
    ...
    public function edit(User $user)
    {
        ...
        // Show the page
        return view('admin.users.edit', compact('user', 'roles', 'userRoles', 'countries', 'status', 'sc'));
    }

            ...
            <div class="card ">
                <div class="card-header bg-primary text-white clearfix">
                    ...
                    <div class="float-right">
                        <a href="{{ route('admin.roles.create') }}" class="btn btn-sm btn-secondary"><span class="fa fa-plus"></span> @lang('button.create')</a>
                    </div>
                </div>
                <br />
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#users_exists" data-name="{!! $role->name !!}" class="users_exists">
                                            <i class="livicon" data-name="warning-alt" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="@lang('roles/form.users_exists')"></i>
                                        </a>
                                        @else
                                        <a href="{{ route('admin.roles.confirm-delete', $role->id) }}" data-toggle="modal" data-id="{{ $role->id }}" data-target="#delete_confirm">
                                            <i class="livicon" data-name="remove-alt" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="@lang('roles/form.delete_role')"></i>
                                        </a>
                                        @endif

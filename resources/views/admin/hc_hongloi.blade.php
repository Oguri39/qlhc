                        ...
                        <form class="form-horizontal" action="#">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="name" type="text" placeholder="Tên Hóa Chất" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <!-- name input-->
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="name" type="text" placeholder="Số lượng" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="name" type="text" placeholder="Đơn vị" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-12">
                                        <input id="name" name="name" type="text" placeholder="Lý do hỏng, lỗi" class="form-control">
                                    </div>
                                </div>
                            </div>

                        ...
                        <table class="table table-striped table-bordered" width="100%" id="table2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class=" form-control" id="row-1-number" name="list[{{$ds['hoaChat']->ma_lo_hoa_chat}}]" min="0" max="{{$ds['soLuongConLai']}}">
                                    </td>
                                    <td>
                                        <label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-3 col-lg-3 col-12 control-label" for="name">Số
                                                    Lượng Dự Trù</label>
                                                <div class="col-md-9 col-lg-9 col-12">
                                                    <input id="name" name="so_luong" type="number" placeholder="Số lượng" class="form-control" min="0" required>
                                                </div>
                                            </div>
                                        </div>

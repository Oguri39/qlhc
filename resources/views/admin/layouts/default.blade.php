...
<head>
    ...
    <style>
        .sidebar-toggle {
            background-color: #ff8d39 !important;
        }
...
<body class="skin-josh">
    <header class="header">
        <a href="" class="logo sidebar-toggle" data-toggle="offcanvas" role="button">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="float-right">
                                    <a class="logout" href="{{ URL::to('admin/logout') }}">
